...
\fancypagestyle{autorskie}{%
    ...
    \fancyfoot[LO]{\includegraphics[height=45pt]{images/kalamarz.jpeg}}
    \fancyfoot[RE]{\includegraphics[height=45pt]{images/ksiazka_bazgroly.png}}
}
...
\input{songs/ryczace_dwudziestki-shenandoah}
...
\input{songs/grzegorz_turnau-bracka}
...
\input{songs/wild_mountain_thyme}
...
\input{songs/bajm-biala_armia}
\input{songs/andrzej_zaucha-cest_la_vie}
\input{songs/bajm-co_mi_panie_dasz}
...
\input{songs/kayah-to_nie_ptak}
\input{songs/raz_dwa_trzy-trudno_nie_wierzyc_w_nic}
\input{songs/t_love-warszawa}
\input{songs/martyna_jakubowicz-w_domach_z_betonu}
\input{songs/andrzej_zaucha-wymyslilem_ciebie}
...
\end{center}
\pagestyle{pop}
\input{songs/edyta_gorniak-to_nie_ja}
...
\end{center}
\pagestyle{autorskie}
\input{songs/nowy-slad-dzien_wojownika}
\input{songs/nowy-slad-niezapominajka}
\input{songs/bouda}
